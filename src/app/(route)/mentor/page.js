...
export default function MentorPage() {
    ...
    const [mentors] = useState([
        {
            ...
            recentAnswers: 45,
            introduction:
                "시즌11부터 다이아 유지중인 정글러입니다. 갱킹 타이밍과 오브젝트 판단에 자신있어요!",
            tags: ["친절함", "상세설명", "빠른답변"],
        },
        {
            id: 2,
            ...
            recentAnswers: 67,
            introduction:
                "마스터 티어 미드 라이너입니다. 라인전 디테일과 로밍 타이밍을 알려드릴게요.",
            tags: ["프로급", "체계적", "심화설명"],
        },
        {
            id: 3,
            ...
            recentAnswers: 23,
            introduction:
                "현재 챌린저 서포터입니다. 비전 컨트롤과 맵 리딩을 중점적으로 가르쳐드려요.",
            tags: ["최고급", "비전마스터", "전략적"],
        },
        {
            id: 4,
        ...
        },
        {
            ...
            recentAnswers: 52,
            introduction:
                "레디언트 제트 원트릭입니다. 엔트리와 오퍼레이터 운용을 가르쳐드려요!",
            tags: ["에임신", "전략적", "친절함"],
        },
        {
            id: 6,
            ...
            recentAnswers: 38,
            introduction:
                "이모탈 컨트롤러 메인입니다. 스모크 타이밍과 맵 컨트롤을 알려드릴게요.",
            tags: ["전문적", "상세설명", "팀플레이"],
        },
    ]);
    ...
    const filteredMentors = mentors.filter((mentor) => {
        ...
        const positionMatch =
            selectedPosition === "all" || mentor.position === selectedPosition;
        const championMatch =
            selectedChampion === "all" ||
            mentor.champions.includes(selectedChampion);
        const tierMatch =
            selectedTier === "all" || mentor.tier.includes(selectedTier);
                        ...
                        <>
                            ...
                            >
                                <div>
                                    ...
                                    >
                                        {getCurrentFilters().positions.map(
                                            (position) => (
                                                <option
                                                    key={position}
                                                    value={position}
                                ...
                                <div>
                                    ...
                                    >
                                        {getCurrentFilters().champions.map(
                                            (champion) => (
                                                <option
                                                    key={champion}
                                                    value={champion}
